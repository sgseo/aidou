<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><head>
  ...
  <?php ($_GET['type'])?'':die('充值链接配置错误！') ?>
  <?php (intval($_GET['u_id'])>0)?'':die('你已掉线！') ?>
    ...
    <div class="col-xs-12 col-sm-10 col-lg-8 center-block" style="float: none;">
      <div class="panel panel-primary">
        ...
        <form name=alipayment action=epayapi.php method=post target="_blank">
            ...
            <input type="hidden" name="lx" value="<?php echo $_GET['type']; ?>">
<br/>
<center>
...
<h6 style="text-align: center;color: #ff2929;">(<?php echo $_GET['u_id']; ?>)支付过程中不要关闭此页面，支付完成一定要返回充值页面等待提示充值成功，否则充值失败。</h6>
