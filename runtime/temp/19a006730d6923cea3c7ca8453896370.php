<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"/www/wwwroot/sp/application/index/view/banner/update.html";i:1559661124;s:50:"/www/wwwroot/sp/application/index/view/layout.html";i:1561713348;}*/ ?>
<!doctype html>
<html>
  ...
  <!--标题-->
       ...
       <div class="panel-heading">
               ...
               <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 广告图片修改
                    </div>
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1"  method="post" action="<?php echo url('banner/edit'); ?>" enctype="multipart/form-data" class="validate">
           ...
           <div class="form-group">
                ...
                <input type="text" class="form-control" name="img" value="<?php echo $data['picurl']; ?>"   placeholder="" />
            </div>
            ...
            <div class="form-group">
                ...
                <br>
                <select class="inp_1" id="cid" name="cid">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="sort"  value="<?php echo $data['sort']; ?>" placeholder="" />
            </div>
            <div class="form-group">
