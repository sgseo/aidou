<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"/www/wwwroot/sp/application/index/view/user/pass.html";i:1559661124;s:50:"/www/wwwroot/sp/application/index/view/layout.html";i:1561713348;}*/ ?>
<!doctype html>
<html>
    ...
    <!--标题-->
       ...
       <div class="panel-heading">
               ...
               <div class="caption font-green bold">
                        <span class="am-icon-code"></span> APP设置
       		  </div>
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1" method="post" action="<?php echo url('user/pass'); ?>" class="validate">
			...
			<div class="form-group">
                <label class="control-label">设置微信号 (会显示在你的下级用户的APP中)</label>

                <input type="text" class="form-control" id="weichat" name="weichat" value="<?php echo $weichat; ?>"  placeholder="设置微信号" />
            </div>
