<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"/www/wwwroot/sp/application/index/view/tv/index.html";i:1559661124;s:50:"/www/wwwroot/sp/application/index/view/layout.html";i:1561713348;}*/ ?>
<!doctype html>
<html>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
               ...
               <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 电视直播管理
         </div>
  ...
  <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
                    ...
                    <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                        ...
                        <tr>
                           ...
                           <th style=" text-align: center;"> <a href="<?php echo url('tv/update',['id'=>$vo['id']]); ?>" title="修改" > <i class="el-edit"></i></a>
                               &nbsp;
                               <a href="<?php echo url('tv/del',['id'=>$vo['id']]); ?>" title="删除" class=btn-single"><i class="el-trash-circled"></i></a></th>
