<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"/www/wwwroot/sp/application/index/view/user/clog.html";i:1559661124;s:50:"/www/wwwroot/sp/application/index/view/layout.html";i:1561713348;}*/ ?>
<!doctype html>
<html>
            ...
            <div class="panel-body">
                <div style="text-align: center">
                    <form class="validate" method="get" action="<?php echo url('user/clog'); ?>">
                        用户id:
                        <input class="form-control" placeholder="&nbsp;用户账户id" type="text" name="id" style="height: 38px">
