<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"/www/wwwroot/sp/application/index/view/vip/advert.html";i:1559661124;s:50:"/www/wwwroot/sp/application/index/view/layout.html";i:1561713348;}*/ ?>
<!doctype html>
<html>
...
<div class="panel panel-default">
        ...
        <form role="form" id="form1" method="post" action="<?php echo url('vip/advert'); ?>" class="validate">
    	 ...
    	 <div class="form-group">
			...
			<div class="form-group">
                <label class="control-labell" for="field-5">APP登录文字提示</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo advert('51'); ?>" name="geng51" >
            </div>   
			
			<div class="form-group">
                <label class="control-labell" for="field-5">APP直播栏目链接</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo advert('52'); ?>" name="geng52" >
            </div>   
			
			<div class="form-group">
                <label class="control-labell" for="field-5">APP登录分享文字内容</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo advert('53'); ?>" name="geng53" >
            </div>   
			<div class="form-group">
                <label class="control-labell" for="field-5">APP登录分享获得VIP天数</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo advert('54'); ?>" name="geng54" >
            </div>   <br/>
			<div class="form-group">
                <label class="control-labell" for="field-5">最新APP版本</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo advert('55'); ?>" name="geng55" >
            </div>   
			<div class="form-group">
                <label class="control-labell" for="field-5">最新APP版本链接</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo advert('56'); ?>" name="geng56" >
            </div>   
            <div class="form-group">
