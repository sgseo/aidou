    ...
    public function advert()
    {
      if (session('power') != 0) {
        ...
        if (request()->Post()) {
            ...
            db('advert')->where('id', 51)->update(['content' => input('geng51')]);
            db('advert')->where('id', 52)->update(['content' => input('geng52')]);
            db('advert')->where('id', 53)->update(['content' => input('geng53')]);
            db('advert')->where('id', 54)->update(['content' => intval(input('geng54'))]);
            db('advert')->where('id', 55)->update(['content' => input('geng55')]);
            db('advert')->where('id', 56)->update(['content' => input('geng56')]);
